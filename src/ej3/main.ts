...
const flattedArray: number[] = array3.flat(); // [[1, 2], [7, 8]] --> [1, 2, 7, 8]
...
// busca un elemento en el array según el predicate, y devuelve el elemento encontrado
const foundArray: number | undefined = array1.find((n: number) => n == 3);
